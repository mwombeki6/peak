...
the existing V1 backend. Applied migrations `V1–V70` remain immutable. The
additive `V71` migration introduces the hospitality platform control plane;
`V68`–`V70` introduced Daily Control, operational staff-reference alignment and
the verified property-payment timeline index.
