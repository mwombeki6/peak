...
class Phase5OpenApiIntegrationTests @Autowired constructor(
    ...
    fun `publishes Phase 5 close and reporting routes`() {
        ...
        val expected = mapOf(
            ...
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}" to "put",
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}/pause" to "post",
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}/resume" to "post",
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}/archive" to "post",
            "/api/v1/tenants/{tenantId}/report-subscriptions/{subscriptionId}/recipients" to "post",
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}/recipients" to "post",
            "/api/v1/properties/{propertyId}/report-subscriptions/{subscriptionId}/recipients/{recipientId}/disable" to "post",
